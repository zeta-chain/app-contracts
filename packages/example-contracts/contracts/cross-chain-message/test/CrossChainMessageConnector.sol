...
contract CrossChainMessageConnector is ZetaConnector {
    function callOnZetaMessage(
        ...
        return
            CrossChainMessage(payable(destinationAddress)).onZetaMessage(
    ...
    function callOnZetaRevert(
        ...
        return
            CrossChainMessage(payable(zetaTxSenderAddress)).onZetaRevert(
