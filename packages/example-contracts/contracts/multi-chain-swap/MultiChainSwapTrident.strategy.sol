...
contract MultiChainSwapTrident is MultiChainSwap, ZetaInteractor, MultiChainSwapErrors, ZetaTokenConsumerTrident {
    ...
    constructor(
        ...
        ZetaTokenConsumerTrident(zetaToken_, uniswapV3Router_, WETH9Address_, poolFactory_)
