...
contract CrossChainWarriors is ERC721("CrossChainWarriors", "CCWAR"), ZetaInteractor, ZetaReceiver {
    ...
    function crossChainTransfer(address to, uint256 tokenId) external {
        ...
        {
            bool success = _zetaToken.transferFrom(msg.sender, address(connector), zetaGasAmount);
