...
import "../CrossChainLending.sol";

contract CrossChainLendingZetaConnector is ZetaConnector {
    ...
    function callOnZetaMessage(
        ...
        return
            CrossChainLending(payable(destinationAddress)).onZetaMessage(
    ...
    function callOnZetaRevert(
        ...
        return
            CrossChainLending(payable(zetaTxSenderAddress)).onZetaRevert(
