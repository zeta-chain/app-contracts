...
export type AppAddress = "multiChainSwap" | "multiChainValue" | "zetaTokenConsumerUniV2" | "zetaTokenConsumerUniV3";

export const getAppAddress = (address: AppAddress, network: ZetaProtocolNetwork): string => {
