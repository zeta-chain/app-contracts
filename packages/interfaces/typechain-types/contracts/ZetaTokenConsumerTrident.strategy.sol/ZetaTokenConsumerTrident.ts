...
export interface ZetaTokenConsumerTridentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "tridentRouter",
    values?: undefined
  ): string;
...
export interface ZetaTokenConsumerTrident extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZetaTokenConsumerTridentInterface;
  ...
  populateTransaction: {
    ...
    tridentRouter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
